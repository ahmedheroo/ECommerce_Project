...
namespace OnlineShoppingStore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        public void Remove(Tbl_Entity entity)
        {
            ...
            //_DBEntity.Set<Tbl_Entity>.Remove(entity)
        }
        ...
        //public Tbl_Entity GetProductById(int id)
        //{
        //    return _DBEntity.Tbl_Product.Find(id);
        //        /*_DBEntity.Tbl_Product.Find(id);*/
        //}

        Tbl_Product IRepository<Tbl_Entity>.GetProductById(int id)
        {
            return _DBEntity.Tbl_Product.Find(id);
        }

        public Tbl_Entity GetProductId(int id)
        {
            return _dbSet.Find(id);
            //return _DBEntity.Tbl_Entity.Find(id);

        }

        public void delete(int ProductId)
        {
            var pro =  _DBEntity.Tbl_Product.Find(ProductId);
            _DBEntity.Tbl_Product.Remove(pro);
            _DBEntity.SaveChanges();
        }
    }
}